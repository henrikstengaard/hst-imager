...
public class CompareViewModel : ViewModelBase
{
    ...
    public long SourceStartOffset { get => _sourceStartOffset; set => this.RaiseAndSetIfChanged(ref _sourceStartOffset, value); }
    public long DestinationStartOffset { get => _destinationStartOffset; set => this.RaiseAndSetIfChanged(ref _destinationStartOffset, value); }
    ...
    private async Task StartCompareAsync()
    {
        ...
        try
        {
            ...
            await _imagingService.CompareAsync(SourcePath, SourceStartOffset, _selectedMedia!.Path,
                DestinationStartOffset, Size, Byteswap, progress, _cts.Token);
        }
