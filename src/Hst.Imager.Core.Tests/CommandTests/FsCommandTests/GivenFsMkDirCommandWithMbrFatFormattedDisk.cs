...
public class GivenFsMkDirCommandWithMbrFatFormattedDisk
{
    [Fact]
    public async Task When_CreatingOneLevelDirectory_Then_DirectoryIsCreated()
    {
        var mediaPath = $"{Guid.NewGuid()}.vhd";
        var mkDirPath = Path.Combine(mediaPath, "mbr", "1", "dir1");
        ...
        try
        {
            ...
            await TestHelper.CreateMbrFatFormattedDisk(testCommandHelper, mediaPath, 100.MB());
            ...
            var entries = await MbrTestHelper.GetEntriesFromFileSystemVolume(testCommandHelper,
                mediaPath, 0, []);
    ...
    {
        var mediaPath = $"{Guid.NewGuid()}.vhd";
        var mkDirPath = Path.Combine(mediaPath, "mbr", "1", "dir1", "dir2", "dir3");
        ...
        try
        {
            ...
            entries = await MbrTestHelper.GetEntriesFromFileSystemVolume(testCommandHelper, mediaPath, 0,
                ["dir1"]);
    ...
    {
        var mediaPath = $"{Guid.NewGuid()}.vhd";
        var mkDirPath = Path.Combine(mediaPath, "mbr", "1", "dir3");
        ...
        try
        {
            ...
            await MbrTestHelper.CreateDirectory(testCommandHelper, mediaPath, 0, ["dir3"]);
    ...
    {
        var mediaPath = $"{Guid.NewGuid()}.vhd";
        var mkDirPath = Path.Combine(mediaPath, "mbr", "1", "dir1", "file1.txt", "dir5");
