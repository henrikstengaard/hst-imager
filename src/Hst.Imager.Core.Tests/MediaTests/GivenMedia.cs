...
public class GivenMedia
{
    ...
    public void When_MediasHasSamePath_Then_EqualsReturnTrue()
    {
        ...
        var media1 = new Media("disk.img", "Disk", Media.MediaType.Raw, 
            false, new MemoryStream(), false);
        var media2 = new Media("disk.img", "Disk", Media.MediaType.Raw, 
            false, new MemoryStream(), false);
    ...
    public void When_MediasHasDifferentPath_Then_EqualsReturnFalse()
    {
        ...
        var media1 = new Media("disk1.img", "Disk", Media.MediaType.Raw, 
            false, new MemoryStream(), false);
        var media2 = new Media("disk2.img", "Disk", Media.MediaType.Raw, 
            false, new MemoryStream(), false);
