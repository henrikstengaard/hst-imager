...
/// <param name="NumberOfFats">Number of FAT on the volume.</param>
/// <param name="RootEntriesCount">Number of root entries for FAT12/FAT16. Must be zero for FAT32.</param>
/// <param name="TotalSectors">Total sectors for FAT12/FAT16. Must be zero for FAT32.</param>
/// <param name="Media">Media. 0xF8 for fixed non removable media. 0xF0 for removable media.</param>
